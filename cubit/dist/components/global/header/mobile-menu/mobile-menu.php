...
$args = [
  ...
  'a_class' => 'relative px-4 inline-block py-6 font-medium leading-5 text-white',
  'a_active_class' => 'after:w-[calc(100%-32px)]',
  'button_container_class' => 'w-full first:border-b-0 border-t border-stone-300',
  'button_class' => 'flex justify-between w-full flex-grow flex-shrink-0 relative block px-4 py-6 font-medium text-white md:text-black leading-5 after:content-none',
  ...
  'before' => '<div class="w-full text-white border-t border-b first:border-b-0 md:text-stone-300 border-stone-300">',
  'after' => '</div>',
  'type' => 'mobile',
];
...
<div class="absolute top-0 left-0 z-10 w-screen h-screen px-4 overflow-y-auto bg-shade-800 xl:hidden" x-show="open"
