          ...
          <div id="slider-container">
            <div class="hidden lg:block">
              <div class="overflow-hidden">
                <div class="relative swiper-container" pagination="true" pagination-type="progressbar" navigation="true" x-ref="swiperDesktop" data-count="<?= count($fields['video']) ?>">
