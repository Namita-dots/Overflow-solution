...
class Tailwind_Walker_Nav_Menu extends Walker {
  ...
  public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
    ...
    $is_active = in_array('current-menu-ancestor', $classes) && !str_contains($item->url, '/coming-soon/');
    ...
    if ($has_sub_menu && $is_top_level_item) {
      ...
      if (isset($args->button_active_class)) {
        ...
        if ($is_active && !str_contains($item->url, '/coming-soon')) {
      ...
      $output .= '<span class="w-5 h-5 transition-all duration-300 icon" :class="{\'rotate-180 mobile_menu_active\' : open , \'rotate-0\' :!open }">' . get_icon('chevron-down') . ' </span> </button>';
    } else {
      $atts = array();
      ...
      if ($depth == 0) {
        ...
        if ($item->current && isset($args->a_active_class) && !str_contains($item->url, '/coming-soon')) {
      ...
      if ($depth > 0) {
        ...
        if ($item->current && isset($args->sub_menu_a_active_class) && !str_contains($item->url, '/coming-soon')) {
